...
var googleFunctions = {
  ...
  getPostsFromTable: function(sheetName) {
    var deferred = q.defer();
    ...
    fs.readFile(
      ...
      function processClientSecrets(err, content) {
        ...
        googleFunctions
          ...
          .then(function(oauth2Client) {
            deferred.resolve(
              googleFunctions.getAllValuesFromSpreadsheet(
                oauth2Client,
                sheetName
              )
            );
  ...
  updatePostStatusOfRow: function(index, sheetName) {
    var deferred = q.defer();
    ...
    fs.readFile(
      ...
      function processClientSecrets(err, content) {
        ...
        googleFunctions
          ...
          .then(function(oauth2Client) {
            deferred.resolve(
              googleFunctions.updateRowAtSpreadsheet(
                oauth2Client,
                index,
                sheetName
              )
  ...
  updateRowAtSpreadsheet: function(auth, index, sheetName) {
    var deferred = q.defer();
  ...
  getAllValuesFromSpreadsheet: function(auth, sheetName) {
    var deferred = q.defer();
